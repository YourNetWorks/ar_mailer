...
* the sending itself can be triggered by method call. You can use ar_sendmail process, or you can use smth else, e.g. BackgrounDRB job
...
The fork is sponsored by Your Net Works, Inc.
...
Then
  ...
  $ sudo gem install artemv-ar_mailer

For Rails >= 2.1, in your environment.rb:
  
  config.gem "artemv-ar_mailer", :lib => 'action_mailer/ar_mailer', :source => 'http://gems.github.com'
